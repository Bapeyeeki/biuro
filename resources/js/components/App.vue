      ...
      <footer class="bg-black/70 py-8 mt-12 border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-6">
          <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 class="text-lg font-bold mb-4 text-white">Biura</h3>
              <ul class="space-y-2 text-gray-400">
                <li><a href="#" class="hover:text-blue-400 transition">Dostępne biura</a></li>
                <li><a href="#" class="hover:text-blue-400 transition">Wirtualne biura</a></li>
                <li><a href="#" class="hover:text-blue-400 transition">Przestrzenie coworkingowe</a></li>
                <li><a href="#" class="hover:text-blue-400 transition">Sale konferencyjne</a></li>
              </ul>
            </div>
            <div>
              <h3 class="text-lg font-bold mb-4 text-white">O nas</h3>
              <ul class="space-y-2 text-gray-400">
                <li><a href="#" class="hover:text-blue-400 transition">Nasza firma</a></li>
                <li><a href="#" class="hover:text-blue-400 transition">Lokalizacje</a></li>
                <li><a href="#" class="hover:text-blue-400 transition">Kariera</a></li>
            ...
            <div>
              ...
              <ul class="space-y-2 text-gray-400">
                <li class="flex items-start">
                  ...
                  <span>ul. Warszawska 142, 02-318 Warszawa</span>
                </li>
                <li class="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 text-blue-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>kontakt@arrisagency.pl</span>
                </li>
                <li class="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 text-blue-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
